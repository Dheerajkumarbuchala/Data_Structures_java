...
public class CountOccurances {
    ...
    public static void countOccurances(int []arr,int m){
        ...
        System.out.println("No of occurances of element " + m + " is : " + (IndexOfLastOccurance.indexOfLastOccurance(arr,m,n) - IndexOfFirstOccurance.indexOfFirstOccurance(arr,m,n) + 1));
    }
}
